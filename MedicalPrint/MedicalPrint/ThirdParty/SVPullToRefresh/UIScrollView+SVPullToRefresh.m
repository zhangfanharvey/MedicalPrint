...
//                                                lineBreakMode:self.titleLabel.lineBreakMode];
        ...
        CGSize titleSize = [self.titleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.titleLabel.font.lineHeight) options:0 attributes:attribute context:nil].size;
...
//                                                      lineBreakMode:self.subtitleLabel.lineBreakMode];
        ...
        attribute = @{NSFontAttributeName: self.titleLabel.font};
        
        CGSize subtitleSize = [self.titleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.titleLabel.font.lineHeight) options:0 attributes:attribute context:nil].size;
